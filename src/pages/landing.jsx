...
function Landing() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      // message: formData.message, // Opcional, si el backend lo acepta
    };
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-[#7fcdc2] text-white py-20 px-6 text-center">
        ...
        <p className="text-lg md:text-xl max-w-2xl mx-auto">
          Una solución poderosa para analizar métricas clave, mejorar relaciones con clientes y tomar decisiones basadas en estadísticas.
        </p>
        <a
          href="/estadisticas"
      ...
      <section id="features" className="py-20 text-center bg-gray-50">
        ...
        <p className="text-lg text-gray-600 max-w-xl mx-auto mb-12">
          Herramientas diseñadas para mejorar la eficiencia, el seguimiento y la toma de decisiones.
        </p>
        <div className="grid gap-8 grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto px-6">
          <div className="bg-white shadow-lg p-6 rounded-xl">
            <h3 className="text-xl font-semibold mb-2">Panel de Indicadores</h3>
            <p className="text-gray-600">Consulta métricas en tiempo real como ventas, retención y satisfacción del cliente.</p>
          </div>
          <div className="bg-white shadow-lg p-6 rounded-xl">
            <h3 className="text-xl font-semibold mb-2">Análisis de Clientes</h3>
            <p className="text-gray-600">Identifica patrones de comportamiento, segmenta audiencias y mejora el enfoque comercial.</p>
          </div>
          <div className="bg-white shadow-lg p-6 rounded-xl">
            <h3 className="text-xl font-semibold mb-2">Exportación de Reportes</h3>
            <p className="text-gray-600">Genera y descarga reportes personalizables en Excel o PDF con un solo clic.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white text-center">
        <h2 className="text-3xl font-extrabold mb-12">Lo que dicen nuestros usuarios</h2>
        <div className="grid gap-8 grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto px-6">
          <div className="bg-gray-100 p-6 rounded-xl">
            <p className="italic">"Nos ha ayudado a visualizar nuestros datos y tomar mejores decisiones de negocio."</p>
            <p className="mt-4 font-semibold">— Laura G., Directora de Ventas</p>
          </div>
          <div className="bg-gray-100 p-6 rounded-xl">
            <p className="italic">"Ahora puedo ver en segundos lo que antes me tomaba días compilar."</p>
            <p className="mt-4 font-semibold">— Carlos M., Analista CRM</p>
          </div>
          <div className="bg-gray-100 p-6 rounded-xl">
            <p className="italic">"El diseño es simple pero potente. Nos ha ahorrado mucho tiempo."</p>
